...
<div class="container">
    ...
    <div class="lista-botoes fundocinza">
        <form method="post" action="<?php echo base_url("acessor/processaLigacao2");?>">
            <div class="row">


                <div class="col-xs-6 cl-sm-6 col-lg-6">
                    <label for="telefone">Telefone</label>
                    <input readonly="readonly" class="form-control" name="telefone" id="telefone" value="<?php echo $record;?>">
                </div>
                <div class="col-xs-6 cl-sm-6 col-lg-6">
